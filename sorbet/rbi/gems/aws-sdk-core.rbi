...
class Aws::STS::Types::GetCallerIdentityResponse < Anonymous_Struct_15
  include Aws::Structure
end
...
class Aws::STS::Types::GetFederationTokenRequest < Anonymous_Struct_16
  include Aws::Structure
end
...
class Aws::STS::Types::GetFederationTokenResponse < Anonymous_Struct_17
  include Aws::Structure
end
...
class Aws::STS::Types::GetSessionTokenRequest < Anonymous_Struct_18
  include Aws::Structure
end
...
class Aws::STS::Types::GetSessionTokenResponse < Anonymous_Struct_19
  include Aws::Structure
end
...
class Aws::STS::Types::IDPCommunicationErrorException < Anonymous_Struct_20
  include Aws::Structure
end
...
class Aws::STS::Types::IDPRejectedClaimException < Anonymous_Struct_21
  include Aws::Structure
end
...
class Aws::STS::Types::InvalidAuthorizationMessageException < Anonymous_Struct_22
  include Aws::Structure
end
...
class Aws::STS::Types::InvalidIdentityTokenException < Anonymous_Struct_23
  include Aws::Structure
end
...
class Aws::STS::Types::MalformedPolicyDocumentException < Anonymous_Struct_24
  include Aws::Structure
end
...
class Aws::STS::Types::PackedPolicyTooLargeException < Anonymous_Struct_25
  include Aws::Structure
end
...
class Aws::STS::Types::PolicyDescriptorType < Anonymous_Struct_26
  include Aws::Structure
end
...
class Aws::STS::Types::RegionDisabledException < Anonymous_Struct_27
  include Aws::Structure
end
